    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function (type) {
            ...
            function dateCtrlInit() {
                var birthday = localStorageToObj("user")["birthday"];
                var dateArr = {
                    yy: parseInt(birthday.substr(0, 4)) - 1900,
                    mm: parseInt(birthday.substr(5, 2)) - 1,
                    dd: parseInt(birthday.substr(8, 2)) - 1
                };
